...
type ESAPI interface{
	...
	GetIndexMappings(copyAllIndexes bool,indexNames string,typeNames string)(string,int,*Indexes,error)
	...
	NewScroll(indexNames string,typeNames string,scrollTime string,docBufferCount int,query string, slicedId,maxSlicedCount int, fields string)(interface{}, error)
